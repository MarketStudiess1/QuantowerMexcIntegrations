...
public class MexcImmediateOrCancelOrderType : LimitOrderType
{
    public override string Id => MexcVendor.IMMEDIATE_OR_CANCEL;

    public override string Name => MexcVendor.IMMEDIATE_OR_CANCEL;

    public MexcImmediateOrCancelOrderType(params TimeInForce[] allowedTimeInForce)
